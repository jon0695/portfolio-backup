...
export default class Player extends Movable {
    constructor(x, y, startingLength) {//cords and player's starting length
        ...
        document.getElementById("right").addEventListener('click', () => this.direction="east");
        document.getElementById("left").addEventListener('click', () => this.direction="west");
        document.getElementById("up").addEventListener('click', () => this.direction="north");
        document.getElementById("down").addEventListener('click', () => this.direction="south");
    }
    ...
    //realized this class needs it's own implementation of this method- written yesterday
    ...
    //I'm kicking myself for not thinking about this yesterday...
    move(player, cords){
        if(super.move(player,cords)){
            player.moveBody(player);//So Easy....
        }
    }
    ...
    moveBody(player) {
        ...
        for (let m = 0; m < player.moveHistory.length; m++) {
            ...
            }// A lot of the code here seems redundant, But I'll fix it when I have a working game.
        }
